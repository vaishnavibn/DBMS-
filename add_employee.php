...
if(isset($_POST['submit'])){
	...
	$_SESSION['acknowledgment'] = 'Staff details updated successfully';
	echo '<script>alert("' . $acknowledgment . '");</script>';
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><Form>Staff details Form</div>
                           ...
                           <form method="post">
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" value="<?php echo $address?>" name="address" placeholder="Enter staff address" class="form-control" required>
								</div>
								<div class="form-group">
									<label class=" form-control-label">Date of birth</label>
									<input type="date" value="<?php echo $birthday?>" name="birthday" placeholder="Enter staff birthday" class="form-control" required>
								</div>
								<div class="form-group">
								<label for="profilePhoto" class="form-control-label">Profile Photo</label> <br>
