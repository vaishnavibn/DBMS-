                              ...
                              <table class="table ">
                                 <thead>
									<tr>
										...
										<th width="15%"style="color:black; font-size:15px">Staff Name</th>
										<th width="14%"style="color:black; font-size:15px">From</th>
										<th width="14%"style="color:black; font-size:15px">To</th>
									   <th width="15%"style="color:black; font-size:15px">Description</th>
									   <th width="18%"style="color:black; font-size:15px">Leave Status</th>
									   <th width="10%"></th>
                                    </tr>
                                 </thead>
                                 <tbody>
